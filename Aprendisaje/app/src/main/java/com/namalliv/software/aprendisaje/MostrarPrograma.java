...
public class MostrarPrograma extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mostrar_programa);
        ...
        String message = intent.getStringExtra(Programas.EXTRA_MESSAGE);
    ...
    private void openFile(String programa)
    {
        String tema = programa;
        tema = capitalizeFirstLetter(tema);
        TextView temas = (TextView) findViewById(R.id.tema);
        temas.setText(tema);
        temas.setTextSize(25);

        temas.setTextColor(ContextCompat.getColor(this, R.color.colorPrimaryDark));
        try {
            InputStream is = getAssets().open("programas/" + programa + ".txt");
            ...
            TextView tv = (TextView) findViewById(R.id.programa_texto);
            tv.setText(text);
            tv.setTextSize(20);
